 ...
 * @param {boolean} options.buildDiagrams - Build only diagrams referenced by the input markdown
...
async function generate (options) {
  ...
  if (buildDiagrams) args.push('--build-diagrams')
...
module.exports = {
  generate,
  checkMarp,
  buildDiagrams: buildPptDiagrams
}
